...
class VistaTasks(Resource):
    ...
    def post(self):
        ...
        content = requests.post(' http://micro_conversion:5001/files',
...
class VistaTaskDetail(Resource):
    ...
    def put(self, task_id):
        ...
        content = requests.put('http://micro_conversion:5001/update-files',
    ...
    def delete(self, task_id):
        ...
        content = requests.delete('http://micro_conversion:5001/delete-files',
